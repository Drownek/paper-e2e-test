...
abstract class TestE2ETask : DefaultTask() {
    ...
    fun runTests() {
        ...
        val javaPath = File(System.getProperty("java.home"), "bin/java" + if (System.getProperty("os.name").lowercase().contains("win")) ".exe" else "").absolutePath

        runCommand(
            userTestsDirectory, 
            "node", "node_modules/@drownek/paper-e2e-runner/cli.js",
            env = mapOf(
